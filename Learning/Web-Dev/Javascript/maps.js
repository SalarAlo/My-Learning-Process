...
// youre also able to "chain" multiple set functions pretty easily the way you do it is by just adding another '.' and calling the function again after the last set method parenthesis closes
